...
-- Tiempo de generación: 21-07-2024 a las 00:50:59
...
-- Procedimientos
--
DROP PROCEDURE IF EXISTS `obtener_detalle_orden_compra`$$
...
DROP PROCEDURE IF EXISTS `spBuscarClientePorRuc`$$
...
DROP PROCEDURE IF EXISTS `spCambiarEstadoAprobado`$$
...
DROP PROCEDURE IF EXISTS `spCambiarEstadoRechazado`$$
...
DROP PROCEDURE IF EXISTS `spCrearDetalleOrdenCompra`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `spCrearDetalleOrdenCompra` (IN `_idordencompra` INT, IN `_item` CHAR(5), IN `_centro` INT, IN `_descripcion` VARCHAR(60), IN `_cantidad` INT, IN `_utm` CHAR(10), IN `_precioUnitario` DECIMAL(10,2))   BEGIN
...
DROP PROCEDURE IF EXISTS `spCrearOrdenCompra`$$
...
DROP PROCEDURE IF EXISTS `spEditarClienteEnOrdenCompra`$$
...
DROP PROCEDURE IF EXISTS `spEditarEmpresaCliente`$$
...
DROP PROCEDURE IF EXISTS `spEliminarEmpresaCliente`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `spEliminarEmpresaCliente` (IN `_idempresacliente` INT)   BEGIN
    UPDATE empresas_cliente
    SET 
        estado = '0',
        fechaFin = NOW()
...
DROP PROCEDURE IF EXISTS `spListarEmpresaClientePorID`$$
...
DROP PROCEDURE IF EXISTS `spListarEmpresasCliente`$$
...
DROP PROCEDURE IF EXISTS `spListarOrdenCompraPorRol`$$
...
DROP PROCEDURE IF EXISTS `spListarProvincias`$$
...
DROP PROCEDURE IF EXISTS `spRegistrarEmpresaCliente`$$
...
DROP PROCEDURE IF EXISTS `spRegistrarEmpresaClienteAPI`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `spRegistrarEmpresaClienteAPI` (IN `_razonSocial` VARCHAR(70), IN `_nroDocumento` VARCHAR(12), IN `_direccion` VARCHAR(60), IN `_correo` VARCHAR(60), IN `_contacto` VARCHAR(40), IN `_celular` CHAR(10), IN `_distrito` VARCHAR(30), IN `_ubigeo` CHAR(12), IN `_telefono` CHAR(12))   BEGIN
...
DROP PROCEDURE IF EXISTS `spu_calcular_totales`$$
...
DROP PROCEDURE IF EXISTS `spu_obetner_orden_compra`$$
...
DROP PROCEDURE IF EXISTS `spu_usuario_editarClave`$$
...
DROP PROCEDURE IF EXISTS `spu_usuario_eliminarUsuario`$$
...
DROP PROCEDURE IF EXISTS `spu_usuario_listarUsuarios`$$
...
DROP PROCEDURE IF EXISTS `spu_usuario_login`$$
...
DROP PROCEDURE IF EXISTS `spu_usuario_registrarUsuario`$$
...
DROP PROCEDURE IF EXISTS `spVerificarCliente`$$
...
CREATE TABLE IF NOT EXISTS `departamentos` (
  ...
  UNIQUE KEY `uk_departamento_departamentos` (`departamento`)
...
(1, 1, '1', 2, 'valvulas', 2, 'unit', 222.00),
(2, 10, '2', 1, 'baldes', 4, '', 10.00),
(3, 10, '1', 1, 'ganchos', 4, '', 20.00),
(4, 11, '1', 2, 'Ropa 1', 2, 'Litros', 40.00),
(5, 11, '2', 3, 'zapato 2', 3, 'kilos', 50.00),
(6, 12, '1', 2, 'algo2', 33, '', 23.00),
(7, 13, '1', 2, 'valvula', 2, 'kilos', 33.00),
(8, 13, '2', 2, 'botas', 2, 'Litros', 222.00),
(9, 14, '2', 2, 'azufradora', 3, 'kilos', 222.00),
(10, 14, '1', 2, 'tornilllos xl 2', 2, 'kilos', 333.00),
(11, 15, '1', 2, 'tornilllos xl 2', 2, 'kilos', 333.00),
(12, 15, '2', 2, 'azufradora', 3, 'Litros', 222.00),
(13, 18, '1', 2, 'gorras', 2, 'KG', 44.00),
(14, 18, '2', 1, 'ponchos', 2, 'L', 44.00),
(15, 19, '1', 2, 'tornilllos xl 2', 2, 'KG', 333.00),
(16, 20, '1', 3, 'CAfe2', 2, 'LT', 222.00),
(17, 21, '1', 3, 'CAfe4', 2, 'LT', 222.00),
(18, 22, '1', 3, 'CAfe6', 2, 'LT', 222.00),
(19, 23, '2', 2, 'cafe 5', 4, 'L', 22.00),
(20, 23, '1', 3, 'CAfe4', 2, 'UNID', 222.00),
(21, 23, '3', 3, 'abas', 4, 'UNID', 22.00),
(22, 24, '1', 3, 'CAfe4', 2, 'LT', 222.00),
(23, 24, '2', 4, 'tornilllos xl 2', 2, 'L', 222.00),
(24, 25, '1', 2, 'Choclos', 4, 'LT', 200.00),
(25, 26, '1', 4, 'Pantallas ', 2, 'UNID', 444.00),
(26, 26, '2', 3, 'Laptops', 3, 'UNID', 700.00),
(27, 27, '1', 2, 'Televisores', 3, 'UNID', 600.00),
(28, 27, '2', 3, 'Impresoras', 4, 'UNID', 700.00),
(29, 28, '2', 3, 'Valvulas', 4, 'UNID', 555.00),
(30, 28, '1', 2, 'Tornillos ', 2, 'UNID', 55.00),
(31, 29, '1', 2, 'Tornillos ', 3, 'UNID', 444.00),
(32, 29, '2', 3, 'rejas', 4, 'UNID', 444.00),
(33, 30, '1', 2, 'puertas ', 12, 'UNID', 78.00),
(34, 30, '2', 3, 'Tornillos ', 23, 'UNID', 11.00),
(35, 33, '1', 2, 'Tornillos 45', 2, 'LT', 44.00),
(36, 33, '2', 2, 'Tornillos 44', 2, 'L', 444.00),
(37, 34, '1', 2, 'Tornillos ', 2, 'KG', 44.00),
(38, 35, '1', 2, 'Tornillos 333', 332, 'LT', 2.00),
(39, 36, '1', 2, 'Tornillos ', 2, 'KG', 44.00);
...
CREATE TABLE IF NOT EXISTS `detalle_usuarios` (
  ...
  KEY `fk_idusuario_detalle_usuarios` (`idusuario`),
  KEY `fk_idempresa_detalle_usuarios` (`idempresa`)
...
CREATE TABLE IF NOT EXISTS `distritos` (
  ...
  KEY `fk_idprovincia_distritos` (`idprovincia`)
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  KEY `fk_distrito_empresa` (`iddistrito`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'falcot tech', '987653', 'chincha', 1010);
...
DROP TABLE IF EXISTS `empresas_cliente`;
CREATE TABLE IF NOT EXISTS `empresas_cliente` (
  `idempresacliente` int NOT NULL AUTO_INCREMENT,
  `razonSocial` varchar(70) NOT NULL,
  ...
  UNIQUE KEY `uk_nroDocumento_empresas_cliente` (`nroDocumento`),
  KEY `fk_iddistrito_empresas_cliente` (`iddistrito`)
...
INSERT INTO `empresas_cliente` (`idempresacliente`, `razonSocial`, `nroDocumento`, `direccion`, `correo`, `iddistrito`, `ubigeo`, `actividadEconomica`, `telefono`, `estado`, `fechaInicio`, `fechaEdicion`, `fechaFin`, `celular`, `contacto`) VALUES
(1, 'Trabajos pesados231', '543411', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '0', '2024-07-15', '2024-07-16', '2024-07-20', '32332', 'dsada'),
(2, 'Trabajos pesados', '54342', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453455', '0', '2024-07-15', '2024-07-20', '2024-07-20', '3213321', 'Juan '),
(3, 'dasdadasd', '3212', 'Av. Grau 114', 'Empresa@gmail.com', 1010, 'dasw', 'dasdasd', '888888888', '1', '2024-07-15', '2024-07-20', NULL, '888888888', 'Luyo'),
(4, 'Trabajos pesados', '543421', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '1', '2024-07-15', '2024-07-20', NULL, '', ''),
(8, 'Trabajos pesados', '543423', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '1', '2024-07-15', NULL, NULL, NULL, NULL),
(15, 'ddasd', '23123', 'dasdasd', 'dasda', 1471, 'dasd', 'dsadasd', '321312', '1', '2024-07-15', NULL, NULL, NULL, NULL),
(17, 'Trabajos pesados', '43223', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '1', '2024-07-16', NULL, NULL, '988775', 'Lucho'),
(18, 'Trabajos pesados45', '33321', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '1', '2024-07-17', NULL, NULL, '988775', 'Lucho'),
(19, 'Trabajos pesados45', '33322', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '1', '2024-07-17', NULL, NULL, '988775', 'Lucho'),
(20, 'Trabajos pesados45', '33324', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '1', '2024-07-17', NULL, NULL, '988775', 'Lucho'),
(21, 'Trabajos pesados45', '33325', 'avenida', 'gmail.com', 1010, '233', 'Trabaajos', '453123', '1', '2024-07-17', NULL, NULL, '988775', 'Lucho'),
(22, 'SOLUCIONES TECNOLOGICAS INDUSTRIALES FALCOT S.A.C.', '20610562176', 'CAL. LUIS GALVEZ RONCEROS NRO 230 C.P. SANTA ROSA ', 'correros', 1010, '110204', NULL, '44231', '1', '2024-07-17', NULL, NULL, '12343212', 'alguien'),
(23, 'INVERSIONES ECOGRUNE S.A.C.', '20605265589', 'CAL. MAR DENTRO MZA. S LOTE 07 DEP. 201 URB. EL OASIS ', 'algo.@gmail.com', 993, '110101', NULL, '2212', '1', '2024-07-17', NULL, NULL, '12343212', 'alva'),
(24, 'SODIMAC PERU S.A.', '20389230724', 'AV. ANGAMOS ESTE NRO 1805 INT. 2 ', 'algsodimao.@gmail.com', 1321, '150141', NULL, '777777777', '1', '2024-07-17', NULL, NULL, '999999999', 'sr. SODIMAC'),
(25, 'dasdasd', '233133233', 'dasdsadas', 'dasdasd', 1010, 'dssadadsasdd', 'dasdasd', '76754453443', '1', '2024-07-18', NULL, NULL, NULL, NULL),
(26, 'tecnologias git', '986786544', 'Chincha Baja', 'Correo..@gmail.com', 993, 'ddas', NULL, '77665565', '1', '2024-07-20', '2024-07-20', NULL, '988766456', 'Luis LLancari');
...
CREATE TABLE IF NOT EXISTS `orden_compra` (
  ...
  KEY `fk_iddetalleusuario_orden_compra` (`iddetalleusuario`),
  KEY `fk_idcliente_orden_compra` (`idcliente`)
...
INSERT INTO `orden_compra` (`idordencompra`, `iddetalleusuario`, `idcliente`, `moneda`, `fechaCreacion`, `descuento`, `grupoCompra`, `destino`, `original`, `estado`, `observaciones`, `condicionPago`, `celular`, `telefono`, `contacto`, `correo`) VALUES
(2, 1, 1, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 1, 17, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 1, 17, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 1, 17, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 1, 17, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(7, 1, 17, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(8, 1, 4, 'dolares', '2024-07-17', '232', 'dasd', 'dasd', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 1, 4, 'dolares', '2024-07-17', '98', 'Grupo b', 'Destino 1', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(10, 1, 4, 'dolares', '2024-07-17', '56', 'grupo 1', 'destino 2', NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL),
(11, 1, 4, 'soles', '2024-07-17', '25', 'grupo 2', ' destino 2', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(12, 1, 4, 'soles', '2024-07-17', '13', 'grupo 3', 'alog', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(13, 1, 22, 'dolares', '2024-07-17', '45', 'compras', 'lugar', NULL, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(14, 1, 23, '', '2024-07-17', '44', 'grupo 1', 'destino 2', NULL, '0', 'nada malo', NULL, NULL, NULL, NULL, NULL),
(15, 1, 24, 'dolares', '2024-07-17', '44', 'grupo 1', 'destino 2', NULL, '2', 'nada malo', NULL, NULL, NULL, NULL, NULL),
(16, 1, 17, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL),
(17, 1, 17, 'rupia', '2024-07-15', '150', 'grupo 1', 'lima', NULL, '0', 'no hay nada', 'aldasdasdasd', NULL, NULL, NULL, NULL),
(18, 1, 24, '', '2024-07-18', '20', 'grupo 1', 'lima', NULL, '2', 'dasdasddadda', '15 dias', NULL, NULL, NULL, NULL),
(19, 1, 1, 'soles', '2024-07-18', '12', 'grupo 1', 'destino 2', NULL, '2', 'nada malo', '122', NULL, NULL, NULL, NULL),
(20, 1, 1, 'soles', '2024-07-18', '23', 'notas', 'lima', NULL, '2', 'ninguna', '7 días', NULL, NULL, NULL, NULL),
(21, 1, 1, 'dolares', '2024-07-18', '2', 'notas', 'lima', NULL, '2', 'ninguna', '15 días', NULL, NULL, NULL, NULL),
(22, 1, 1, 'soles', '2024-07-18', '23', 'notas', 'lima', NULL, '0', 'ninguna', '7 días', NULL, NULL, NULL, NULL),
(23, 1, 1, 'soles', '2024-07-18', '345', 'notas', 'lima', NULL, '1', 'ninguna', '', NULL, NULL, NULL, NULL),
(24, 1, 1, 'soles', '2024-07-18', '33', 'notas', 'lima', NULL, '1', 'ninguna', '7 días', NULL, NULL, NULL, NULL),
(25, 1, 22, 'dolares', '2024-07-19', '0', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'Observaciones 1', '7 días', NULL, NULL, NULL, NULL),
(26, 1, 22, 'dolares', '2024-07-20', '23', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '2', 'Observaciones 1', '', NULL, NULL, NULL, NULL),
(27, 1, 24, 'soles', '2024-07-20', '50000', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '2', 'Observaciones 1', '7 días', NULL, NULL, NULL, NULL),
(28, 1, 23, 'soles', '2024-07-20', '5000', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'Observaciones 1', '', NULL, NULL, NULL, NULL),
(29, 1, 22, 'soles', '2024-07-20', '600', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'Observaciones 1', '7 días', NULL, NULL, NULL, NULL),
(30, 1, 24, 'soles', '2024-07-20', '50', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', '', '', NULL, NULL, NULL, NULL),
(31, 1, 22, 'soles', '2024-07-20', '6', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'observaciones 1', '15 días', NULL, NULL, NULL, NULL),
(32, 1, 22, 'soles', '2024-07-20', '6', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'observaciones 1', '15 días', NULL, NULL, NULL, NULL),
(33, 1, 22, 'dolares', '2024-07-20', '5', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'ovbesrdsa', '15 días', '12343212', '44231', 'alguien', 'correros'),
(34, 1, 22, 'dolares', '2024-07-20', '20', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'dsadas', '15 días', '12343212', '44231', 'alguien', 'correros'),
(35, 1, 22, 'soles', '2024-07-20', '0', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'dasdasd', '7 días', '12343212', '44231', 'alguien', 'correos@'),
(36, 1, 22, 'soles', '2024-07-20', '0', '', 'CAL. LUIS GALVEZ RONCEROS 230 C. P.  SANTA ROSA', NULL, '1', 'sdfsd', '', '12343212', '44231', 'alguien', 'correros');
...
CREATE TABLE IF NOT EXISTS `provincias` (
  ...
  KEY `fk_iddepartamento_provincias` (`iddepartamento`)
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  UNIQUE KEY `uk_clave_usuarios` (`usuario`),
  KEY `fk_idrol_usuarios` (`idrol`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'admin', '$2y$10$iELw61Jk73JJScbE2U2JlettPjBC6raXuyvWuk46ApVwgtHiO3qVC', 'Luis', 'Llancari', 1, '1', '2024-07-16', NULL),
(2, 'mark', '$2y$10$zGpNUqsSq6Pupk1.jpJmyuT8Q/3RGqH3oB11pVwgzpROriM0AnZFW', 'Marcos', 'Lona', 2, '1', '2024-07-20', NULL);
